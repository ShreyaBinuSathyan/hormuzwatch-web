...
/* --- fix: selectbox closed value --- */
div[data-baseweb="select"] > div {{ background-color: #14202E !important; border: 1px solid #3A4A5C !important; }}
div[data-baseweb="select"] > div * {{ color: #FFFFFF !important; }}

/* --- fix: open dropdown list — cast a wide net across every BaseWeb variant --- */
